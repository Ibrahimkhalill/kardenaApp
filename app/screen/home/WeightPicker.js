...
const WeightPicker = ({ navigation }) => {
  ...
  const [height, setHeight] = useState(170); // Default height value in kg
  ...
  const gestureHandler = useAnimatedGestureHandler({
    ...
    onEnd: () => {
      const step = unit === "kg" ? 1 : 0.5; // Step size based on unit
      const maxValue = unit === "kg" ? 250 : 98; // Max height based on unit
      const minValue = unit === "kg" ? 50 : 20; // Min height based on unit
        ...
        <View style={styles.unitSelector}>
          ...
          >
            <Text
              style={[
                ...
                unit === "lb" && styles.selectedUnitText,
              ]}
            >
              lb
            </Text>
          ...
          >
            <Text
              style={[
                styles.unitButtonText,
                unit === "kg" && styles.selectedUnitText,
              ]}
            >
              kg
            </Text>
        ...
        <PanGestureHandler onGestureEvent={gestureHandler}>
          <Animated.View style={[styles.rulerContainer, animatedStyle]}>
            ...
            <View style={styles.scaleContainer}>
              {[...Array(41).keys()].map((i) => {
                const scaleValue = unit === "kg" ? 150 + i : 55 + i * 0.5;
