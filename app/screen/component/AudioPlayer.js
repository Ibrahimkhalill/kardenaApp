...
export default function AudioPlayer({ audio }) {
  ...
  const waveformData = [
    ...
    10, 20, 25, 20, 10, 20, 10, 20, 25, 20, 10, 10, 20, 25, 20, 10, 20, 10, 20,10
  ];
  ...
  return (
    <View style={{ alignItems: "center" }}>
      <View style={styles.container}>
        ...
        <Svg height="50" width="250" style={styles.waveform}>
          {waveformData.map((height, index) => (
            <Rect
              ...
              fill={index < filledBars ? "#32CD32" : "gray"} // Green for played, gray for unplayed
